...
const salarios=[];
salarios.push({name:'Juanita',
                trabajos:[{year:2018,empresa:'Freelance',salario:250,},
...
salarios.push({name:'Alex',
                trabajos:[{year:2018,empresa:'Freelance',salario:450,},
...
salarios.push({name:'Nath',
                trabajos:[{year:2018,empresa:'Freelance',salario:600,},
...
salarios.push({name:'Julia',
                trabajos:[{year:2018,empresa:'MarketerosCOL',salario:1000,},
...
salarios.push({name:'Jonatan',
                trabajos:[{year:2019,empresa:'MarketerosCOL',salario:1000,},
...
salarios.push({name:'Dilan',
                trabajos:[{year:2018,empresa:'Freelance',salario:500,},
...
salarios.push({name:'Zamir',
            trabajos:[{year:2018,empresa:'Freelance',salario:400,},
            {year:2019,empresa:'Freelance',salario:500,},
...
salarios.push({name:'Daniel',
            trabajos:[{year:2020,empresa:'Freelance',salario:150,},
            {year:2021,empresa:'Freelance',salario:450,},
            {year:2022,empresa:'Freelance',salario:550,},
            {year:2023,empresa:'Freelance',salario:650,},
        ],});
salarios.push({name:'Rigoberto',
            trabajos:[{year:2018,empresa:'MarketerosCOL',salario:700,},
...
salarios.push({name:'Alicia',
            trabajos:[{year:2018,empresa:'Inversionify',salario:300,},
...
salarios.push({name:'Bruce',
                trabajos:[{year:2018,empresa:'Wayne Enterprises',salario:4600,},
...
salarios.push({name:'Alfred',
                trabajos:[{year:2018,empresa:'Wayne Enterprises',salario:2000,},
...
salarios.push({name:'Clark Kent',
                trabajos:[{year:2018,empresa:'Daily Planet',salario:1000,},
...
salarios.push({name:'Lois Lane',
                trabajos:[{year:2018,empresa:'Daily Planet',salario:2000,},
...
salarios.push({name:'Jimmy Olsen',
                trabajos:[{year:2018,empresa:'Daily Planet',salario:1500,},
...
salarios.push({name:'Perry White',
                trabajos:[{year:2018,empresa:'Daily Planet',salario:3500,},
...
salarios.push({name:'Lex Luthor',
                trabajos:[{year:2018,empresa:'LexCorp',salario:5000,},
